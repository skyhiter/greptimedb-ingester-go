...
func TestParseSchemaWithTags(t *testing.T) {
	...
	assertFields := func(t *testing.T, schema Schema) {
		...
		assert.EqualValues(t, newColumnSchema("datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), schema.fields[16])
		...
		assert.EqualValues(t, newColumnSchema("ptr_datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), schema.fields[16+offset])
...
func TestParseTimestampViaIntType(t *testing.T) {
	...
	assertFields := func(t *testing.T, schema Schema) {
		...
		assert.EqualValues(t, newColumnSchema("datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), schema.fields[1])
...
func TestParseWithValues(t *testing.T) {
	...
	DATETIME_INT := TIMESTAMP.UnixMicro()
	...
	assertSchema := func(cols []*gpb.ColumnSchema) {
		...
		assert.EqualValues(t, newColumnSchema("datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[16])
		...
		assert.EqualValues(t, newColumnSchema("datetime_int_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[22])
		...
		assert.EqualValues(t, newColumnSchema("ptr_datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[16+offset])
		...
		assert.EqualValues(t, newColumnSchema("ptr_datetime_int_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[22+offset])
	...
	assertValue := func(row *gpb.Row) {
		...
		assert.EqualValues(t, &gpb.Value{ValueData: &gpb.Value_TimestampMicrosecondValue{TimestampMicrosecondValue: DATETIME_INT}}, vals[16])
		...
		assert.EqualValues(t, &gpb.Value{ValueData: &gpb.Value_TimestampMicrosecondValue{TimestampMicrosecondValue: DATETIME_INT}}, vals[22])
		...
		assert.EqualValues(t, &gpb.Value{ValueData: &gpb.Value_TimestampMicrosecondValue{TimestampMicrosecondValue: DATETIME_INT}}, vals[16+offset])
		...
		assert.EqualValues(t, &gpb.Value{ValueData: &gpb.Value_TimestampMicrosecondValue{TimestampMicrosecondValue: DATETIME_INT}}, vals[22+offset])
...
func TestParseWithNilValues(t *testing.T) {
...

	{
		...
		assert.EqualValues(t, newColumnSchema("ptr_datetime_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[16])
		...
		assert.EqualValues(t, newColumnSchema("ptr_datetime_int_column", gpb.SemanticType_FIELD, gpb.ColumnDataType_TIMESTAMP_MICROSECOND), cols[22])
